...
export const useEquipmentStore = defineStore('equipment', () => {
  ...
  // --- ACTIONS for the entire gear closet ---
  ...
  return {
    allEquipment, activityEquipment, isLoading,
    fetchAllEquipment, createEquipment, fetchEquipmentForActivity, addEquipmentToActivity, removeEquipmentFromActivity,
  };
});
