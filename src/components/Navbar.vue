    ...
    <nav class="bg-white shadow-sm border-b border-verve-light relative z-50">
      <div class="container mx-auto px-6 py-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 items-center gap-4">
          ...
          <div class="hidden md:flex items-center space-x-6 text-sm font-medium text-verve-dark">
            <router-link to="/dashboard" class="hover:text-verve-brown transition-colors">Home</router-link>
            ...
            <div class="relative" @mouseenter="openMenu('training')" @mouseleave="closeMenu"
              ...
              <span class="cursor-pointer hover:text-verve-brown flex items-center py-2"
                ...
                Training <span class="ml-1 text-[10px] transition-transform duration-200"
              ...
              <transition enter-active-class="transition ease-out duration-100"
                ...
                <div v-show="activeMenu === 'training'"
                  ...
                  <router-link to="/activities"
                    class="block px-4 py-2 hover:bg-verve-light text-verve-brown/80 hover:text-verve-brown">Activities</router-link>
                  <router-link to="/calendar"
                    class="block px-4 py-2 hover:bg-verve-light text-verve-brown/80 hover:text-verve-brown">Calendar</router-link>
                </div>
              </transition>
            </div>
            ...
            <div class="relative" @mouseenter="openMenu('planning')" @mouseleave="closeMenu"
              ...
              <span class="cursor-pointer hover:text-verve-brown flex items-center py-2"
                ...
                Planung <span class="ml-1 text-[10px] transition-transform duration-200"
              ...
              <transition enter-active-class="transition ease-out duration-100"
                ...
                <div v-show="activeMenu === 'planning'"
                  ...
                  <router-link to="/goals"
                    class="block px-4 py-2 hover:bg-verve-light text-verve-brown/80 hover:text-verve-brown">Goals</router-link>
                  <router-link to="/locations"
                    class="block px-4 py-2 hover:bg-verve-light text-verve-brown/80 hover:text-verve-brown">Locations</router-link>
                </div>
              </transition>
            </div>
          ...
          <div class="flex items-center justify-end space-x-4">
            ...
            <div class="relative" @mouseenter="openMenu('user')" @mouseleave="closeMenu" @click="toggleMenu('user')">
              <button
                class="flex items-center space-x-2 text-verve-dark hover:text-verve-brown transition-colors focus:outline-none py-2">
              ...
              <transition enter-active-class="transition ease-out duration-100"
                ...
                <div v-show="activeMenu === 'user'"
                  ...
                  <div class="px-4 py-2 border-b border-verve-light mb-1">
                    ...
                    <p class="text-sm font-bold text-verve-brown truncate">{{ userStore.user_name }}</p>
                  </div>
